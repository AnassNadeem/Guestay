    ...
    <div className="bg-paper pt-24 md:pt-28">
      <div className="container-page max-w-narrow pb-20">
        ...
        <p className="mt-3 text-ink-muted">
          Prefer a negotiated deposit + monthly rate? Tell us what you need ΓÇö
        ...
        {status === "ok" && (
          <p className="mt-6 rounded-soft border border-olive/20 bg-olive/5 px-4 py-3 text-sm text-ink">
            Thanks ΓÇö we received your request and will be in touch soon.
          </p>
        )}
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-4">
          ...
          >
            {status === "sending" ? "SendingΓÇª" : "Submit quote request"}
          </button>
        </form>
